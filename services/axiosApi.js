...
export const updatePacienteImage = async (id, data) => {
    if (!id) return handleError("No se encontró el id del paciente");
    return handlePetitions({ method: 'patch', data, route: `data/paciente?id=${id}&opt=datosBasicos`, customError: "Error al actualizar el paciente" });
}
